    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferences', models.JSONField(blank=True, default=dict, help_text='User-level notification and appearance preferences. Shape: {email_notifications, desktop_notifications, compliance_alerts, risk_alerts, evidence_reminders, theme, language}')),
            ],
            options={
                'db_table': 'users',
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner'), ('admin', 'Administrator'), ('manager', 'Manager'), ('analyst', 'Analyst'), ('auditor', 'Auditor'), ('viewer', 'Viewer')], default='viewer', max_length=20)),
                ('token', models.CharField(default=secrets.token_urlsafe, max_length=64, unique=True)),
        ...
        migrations.AddIndex(
            model_name='invitation',
            index=models.Index(fields=['company', '-created_at'], name='invitations_company_38e4da_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
